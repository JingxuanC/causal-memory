...
| B (causal memory) | 5/6 | 8.2 | 67% (2/3) | 33% (1/3) |

B failure modes: 1 unsolved (step budget exhausted) · 7 invalid-action steps · 0 LLM call failures (after retries)

B extras: memory writes 2 · searches 10 · post-search first-action hit rate 33% (2/6)
